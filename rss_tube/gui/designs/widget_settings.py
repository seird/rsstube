...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.line_mpv_path = QtWidgets.QLineEdit(self.groupBox_5)
        self.line_mpv_path.setReadOnly(True)
        self.line_mpv_path.setObjectName("line_mpv_path")
        self.horizontalLayout_3.addWidget(self.line_mpv_path)
        self.pb_mpv_path = QtWidgets.QPushButton(self.groupBox_5)
        self.pb_mpv_path.setMaximumSize(QtCore.QSize(30, 16777215))
        self.pb_mpv_path.setObjectName("pb_mpv_path")
        self.horizontalLayout_3.addWidget(self.pb_mpv_path)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_5.setTitle(_translate("Dialog", "MPV path"))
        self.pb_mpv_path.setText(_translate("Dialog", "..."))
